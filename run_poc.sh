...
#   TARGET  mmh-poc-v2  30 primary × 1 replica = 60 shards  (right-sized)
#
...
# step "Step 4 – _reindex mmh-poc-restored → mmh-poc-v2  [30p×1r = 60 shards]"
# uv run python -m scripts.step04_reindex_target

# step "Step 5 – Remote _reindex delta docs (indexed_at > snapshot end_time) from source → mmh-poc-v2"
